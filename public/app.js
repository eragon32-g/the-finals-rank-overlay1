...
const VOIDRAGE_INFERNO_LAYOUT_LOCKED = {
  ...
  "background": "/assets/premium/voidrage-inferno-bg-v101.png",
  "elements": {
    "badge": {
      "x": 12,
      "y": 20,
...
/* RankTag V101 Plus style finalizer */
...
/* RankTag V101 - single source image-base Plus engine */
...
/* RankTag V101 - Premium backdrop engine: Cyber Red Elite keeps the stable CSS layout and adds a premium skin image */
  ...
  function ensureStyle() {
    ...
    style.textContent = `
      ...
      #badge.badge.rt78-cyber-red-elite {
        ...
        background: transparent url('/assets/premium/cyber-red-elite-bg-v96.png?v=101') center / 100% 100% no-repeat !important;
...
`;
    style.textContent += `
/* RankTag V101 - locked premium coordinates from Layout Editor */
#badge.rt78-cyber-red-elite .rank-mark,
...
/* RankTag V101 - Premium backdrop engine: full 470x160 background adapted to stable layout */
...
/* RankTag V101 - runtime premium layout from URL param */
...
/* RankTag V101 - AUTHORITATIVE premium layout sync */
...
/* RankTag V101 - DETACHED PREMIUM RENDERER
...
(function rankTagDetachedPremiumRendererV92(){
  ...
  function getCurrentData() {
    ...
    const badgeSrc = badgeImage?.getAttribute("src") || rankIcon?.querySelector("img")?.getAttribute("src") || "/assets/badges/platinum.svg?v=101";
  ...
  function renderDetached() {
    ...
    root.innerHTML = `
      <img class="rt92-layer-bg" src="${esc(layout.background)}?v=101" alt="" />
...
/* RankTag V101 - MULTI PREMIUM DETACHED RENDERER */
(function rankTagMultiPremiumDetachedRendererV97(){
  ...
  function getCurrentData() {
    ...
    const brandValue = (brandMarqueeText?.textContent || "ERDRAGON32 • Join the Discord").trim();
    const badgeSrc = badgeImage?.getAttribute("src") || "/assets/badges/platinum.svg?v=101";
    return { rankValue, scoreValue, playerValue, brandValue, badgeSrc };
  }
  ...
  function renderDetached() {
    ...
    root.innerHTML = `
      <img class="rt97-layer-bg" src="${esc(layout.background)}?v=101" alt="" />
