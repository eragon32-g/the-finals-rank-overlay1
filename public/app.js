...
const VOIDRAGE_INFERNO_LAYOUT_LOCKED = {
  ...
  "background": "/assets/premium/voidrage-inferno-fit-v110.png",
  "elements": {
    "badge": {
      "x": 12,
      "y": 20,
...
/* RankTag 1.0.10 Plus style finalizer */
...
/* RankTag 1.0.10 - single source image-base Plus engine */
...
/* RankTag 1.0.10 render marker */
document.documentElement.setAttribute("data-ranktag-version", "1.0.10");
...
/* RankTag 1.0.10 - Premium backdrop engine: Cyber Red Elite keeps the stable CSS layout and adds a premium skin image */
  ...
  function ensureStyle() {
    ...
    style.textContent = `
      ...
      #badge.badge.rt78-cyber-red-elite {
        ...
        background: transparent url('/assets/premium/cyber-red-elite-bg-v96.png?v=110') center / 100% 100% no-repeat !important;
...
`;
    style.textContent += `
/* RankTag 1.0.10 - locked premium coordinates from Layout Editor */
#badge.rt78-cyber-red-elite .rank-mark,
...
/* RankTag 1.0.10 - Premium backdrop engine: full 470x160 background adapted to stable layout */
...
/* RankTag 1.0.10 - runtime premium layout from URL param */
...
/* RankTag 1.0.10 - AUTHORITATIVE premium layout sync */
...
/* RankTag 1.0.10 - DETACHED PREMIUM RENDERER
...
(function rankTagDetachedPremiumRendererV92(){
  ...
  function getCurrentData() {
    ...
    const badgeSrc = badgeImage?.getAttribute("src") || rankIcon?.querySelector("img")?.getAttribute("src") || "/assets/badges/platinum.svg?v=110";
  ...
  function renderDetached() {
    ...
    root.innerHTML = `
      <img class="rt92-layer-bg" src="${esc(layout.background)}?v=110" alt="" />
...
/* RankTag 1.0.10 - MULTI PREMIUM DETACHED RENDERER */
(function rankTagMultiPremiumDetachedRendererV97(){
  ...
  const PREMIUM_LAYOUTS = {
    ...
    "voidrage-inferno": (typeof VOIDRAGE_INFERNO_LAYOUT_LOCKED !== "undefined" ? VOIDRAGE_INFERNO_LAYOUT_LOCKED : {"version": "1.0.10", "schema": "ranktag-premium-layout-v2", "style": "voidrage-inferno", "note": "Secondo overlay premium separato. Posizioni gestibili via Layout Editor.", "canvas": {"width": 470, "height": 160}, "background": "/assets/premium/voidrage-inferno-fit-v110.png", "elements": {"badge": {"x": 12, "y": 20, "w": 118, "h": 110, "fontSize": 0, "z": 5}, "rank": {"x": 150, "y": 42, "w": 230, "h": 30, "fontSize": 25, "z": 6}, "score": {"x": 152, "y": 78, "w": 120, "h": 16, "fontSize": 12, "z": 6}, "player": {"x": 265, "y": 78, "w": 150, "h": 16, "fontSize": 10.5, "z": 6}, "brand": {"x": 152, "y": 108, "w": 260, "h": 18, "fontSize": 9.5, "z": 6}}})
  };
  ...
  function getCurrentData() {
    ...
    const brandValue = (brandMarqueeText?.textContent || "ERDRAGON32 • Join the Discord").trim();
    const badgeSrc = badgeImage?.getAttribute("src") || "/assets/badges/platinum.svg?v=110";
    return { rankValue, scoreValue, playerValue, brandValue, badgeSrc };
  }
  ...
  function renderDetached() {
    ...
    root.innerHTML = `
      <img class="rt97-layer-bg" src="${esc(layout.background)}?v=110" alt="" />
...
/* RankTag 1.0.10 - FINAL AUTHORITATIVE PREMIUM RENDERER */
(function rankTagV103FinalPremiumRenderer(){
  ...
  function data() {
    return {
      ...
      badge: badgeImage?.getAttribute("src") || "/assets/badges/platinum.svg?v=110"
    };
  }
  ...
  function render() {
    ...
    root.innerHTML = `
      <img class="rt103-bg" src="${esc(layout.background)}?v=110" alt="" />
