...
/* RankTag v1.0.4 Plus style finalizer */
...
/* RankTag v1.0.4 - single source image-base Plus engine */
...
/* RankTag v1.0.4 - Premium backdrop engine: Cyber Red Elite keeps the stable CSS layout and adds a premium skin image */
...
`;
    style.textContent += `
/* RankTag v1.0.4 - locked premium coordinates from Layout Editor */
#badge.rt78-cyber-red-elite .rank-mark,
...
/* RankTag v1.0.4 - Premium backdrop engine: full 470x160 background adapted to stable layout */
...
/* RankTag v1.0.4 - runtime premium layout from URL param */
...
/* RankTag v1.0.4 - AUTHORITATIVE premium layout sync */
...
/* RankTag v1.0.4 - DETACHED PREMIUM RENDERER
...
/* RankTag v1.0.4 - MULTI PREMIUM DETACHED RENDERER */
...
/* RankTag v1.0.4 - FINAL AUTHORITATIVE PREMIUM RENDERER */
...
/* RankTag v1.0.4.3 - SINGLE AUTHORITATIVE PREMIUM RENDERER FIX
...
(function rankTagV1053AuthoritativePremiumRenderer(){
  ...
  const VOID_DEFAULT = {"version":"105.3","schema":"ranktag-premium-layout-v2","style":"voidrage-inferno","canvas":{"width":470,"height":160},"background":"/assets/premium/voidrage-inferno-v104.png","elements":{"badge":{"x":20,"y":26,"w":102,"h":102,"fontSize":0,"z":5},"rank":{"x":150,"y":43,"w":245,"h":30,"fontSize":25,"z":6},"score":{"x":152,"y":79,"w":120,"h":16,"fontSize":12,"z":6},"player":{"x":268,"y":79,"w":160,"h":16,"fontSize":10.5,"z":6},"brand":{"x":152,"y":108,"w":260,"h":18,"fontSize":9.5,"z":6}}};
...
/* RankTag v1.0.4 - release premium renderer guard
...
/* RankTag v1.0.4 - FINAL PREMIUM RENDERER
   Fix:
...
(function rankTagV101FinalPremiumRenderer(){
  ...
  const DEFAULTS = {
    "cyber-red-elite": {
      version:"1.0.4", schema:"ranktag-premium-layout-v2", style:"cyber-red-elite",
    ...
    "voidrage-inferno": {
      version:"1.0.4", schema:"ranktag-premium-layout-v2", style:"voidrage-inferno",
      canvas:{width:470,height:160}, background:"/assets/premium/voidrage-inferno-v104.png",
      elements:{
  ...
  function currentData(){
    return {
      ...
      player:(nameText?.textContent || (typeof getPlayerFromUrl === "function" ? getPlayerFromUrl() : "NOMEPLAYER#1234")).trim(),
      brand:(brandMarqueeText?.textContent || "VOIDRAGE32 • THE FINALS").trim(),
      badge:badgeImage?.getAttribute("src") || rankIcon?.querySelector("img")?.getAttribute("src") || "/assets/badges/platinum-1.png?v=104"
    };
  }
  function ensureStyle(){
  ...
  function render(){
    ...
    root.innerHTML=`
      <img class="rt-v101-bg" src="${esc(l.background)}?v=104" alt="" />
