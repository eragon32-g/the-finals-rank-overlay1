...
const VOIDRAGE_INFERNO_LAYOUT_LOCKED = {
  ...
  "background": "/assets/premium/voidrage-inferno-fit-v103-solid-panel.png",
  "elements": {
    "badge": {
      "x": 12,
      "y": 20,
...
/* RankTag V105 Plus style finalizer */
...
/* RankTag V105 - single source image-base Plus engine */
...
/* RankTag V105 - Premium backdrop engine: Cyber Red Elite keeps the stable CSS layout and adds a premium skin image */
...
`;
    style.textContent += `
/* RankTag V105 - locked premium coordinates from Layout Editor */
#badge.rt78-cyber-red-elite .rank-mark,
...
/* RankTag V105 - Premium backdrop engine: full 470x160 background adapted to stable layout */
...
/* RankTag V105 - runtime premium layout from URL param */
...
/* RankTag V105 - AUTHORITATIVE premium layout sync */
...
/* RankTag V105 - DETACHED PREMIUM RENDERER
...
/* RankTag V105 - MULTI PREMIUM DETACHED RENDERER */
...
/* RankTag V105 - FINAL AUTHORITATIVE PREMIUM RENDERER */
...
(function rankTagV1053AuthoritativePremiumRenderer(){
  ...
  const VOID_DEFAULT = {"version":"105.3","schema":"ranktag-premium-layout-v2","style":"voidrage-inferno","canvas":{"width":470,"height":160},"background":"/assets/premium/voidrage-inferno-fit-v103-solid-panel.png","elements":{"badge":{"x":20,"y":26,"w":102,"h":102,"fontSize":0,"z":5},"rank":{"x":150,"y":43,"w":245,"h":30,"fontSize":25,"z":6},"score":{"x":152,"y":79,"w":120,"h":16,"fontSize":12,"z":6},"player":{"x":268,"y":79,"w":160,"h":16,"fontSize":10.5,"z":6},"brand":{"x":152,"y":108,"w":260,"h":18,"fontSize":9.5,"z":6}}};
...
/* RankTag v1.0.3 - FINAL PREMIUM RENDERER
   Fix:
...
(function rankTagV101FinalPremiumRenderer(){
  ...
  const DEFAULTS = {
    "cyber-red-elite": {
      version:"1.0.3", schema:"ranktag-premium-layout-v2", style:"cyber-red-elite",
    ...
    "voidrage-inferno": {
      version:"1.0.3", schema:"ranktag-premium-layout-v2", style:"voidrage-inferno",
      canvas:{width:470,height:160}, background:"/assets/premium/voidrage-inferno-fit-v103-solid-panel.png",
      elements:{
  ...
  function currentData(){
    return {
      ...
      player:(nameText?.textContent || (typeof getPlayerFromUrl === "function" ? getPlayerFromUrl() : "NOMEPLAYER#1234")).trim(),
      brand:(brandMarqueeText?.textContent || "VOIDRAGE32 • THE FINALS").trim(),
      badge:badgeImage?.getAttribute("src") || rankIcon?.querySelector("img")?.getAttribute("src") || "/assets/badges/platinum-1.png?v=103"
    };
  }
  function ensureStyle(){
  ...
  function render(){
    ...
    root.innerHTML=`
      <img class="rt-v101-bg" src="${esc(l.background)}?v=103" alt="" />
